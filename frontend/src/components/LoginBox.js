      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" action="#" method="POST" onSubmit={handleSubmitForm}>
          ...
          <div className="flex justify-around ">
            <div className="basis-1/2 bg-red-600 p-2 rounded-lg m-1 cursor-pointer  hover:bg-red-400">
              <GoogleIcon sx={{ color: "white" }} />
            </div>
            <div className="basis-1/2 bg-blue-700 p-2 rounded-lg m-1  cursor-pointer hover:bg-blue-400">
